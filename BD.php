		...
		*/
		...
		{	//Se hace la conexión con la base de datos
			...
			$resultado = $conexion->query( $sql );
				...
				$salida.="<label for='exampleInputEmail1'>	Signos y Sintomas  </label><br>";
				$salida.="<select ng-model='id_sintomas' ng-change='cargar_datos_php()' id='datos' multiple size='10' class='form-control' 
				name='$nombre_lista' >";
				$contador=0;
